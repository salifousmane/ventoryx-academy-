...
urlpatterns = [
    ...
    path('api/blog/recent/', views.api_blog_recent, name='api_blog_recent'),
    path('api/temoignages/recentes/', views.api_temoignages_recent, name='api_temoignages_recent'),
    path('api/newsletter/', views.api_newsletter, name='api_newsletter'),
    path('set-language/', views.set_language_api, name='set_language_api'),
