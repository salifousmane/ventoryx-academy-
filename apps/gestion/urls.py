...
urlpatterns = [
    ...
    path('pedagogie/parcours/', views.pedagogie_gerer_parcours, name='pedagogie_gerer_parcours'),
    ...
    path('technique/taches/', views.technique_liste_taches, name='technique_liste_taches'),
